...
const char* ssid = "Your SSID"; // place wifi ssid
const char* password = "Your password";// place wifi password
...
String url1="/api/sendhttp.php?sender=MSGIND&route=4&mobiles="your mobile number"&authkey=191733AzlOSig9aM5a507740&country=91&message=testing";// after giving your mobile number remove quotation marks
